...
// GPA GOAL GRADE
    function test1(){
      ...
      return currAlerts[0].currAlert
       ...
       //      return "D-";
       //  }else if(newFinalValue >= 64 && newFinalValue <= 66){
       //      return "D";
       //  }else if(newFinalValue >= 67 && newFinalValue <= 69){
       //      return "D+";
       //  }else if(newFinalValue >= 70 && newFinalValue <= 73){
       //      return "C-";
       //  }else if(newFinalValue >= 74 && newFinalValue <= 76){
       //      return "C";
       //  }else if(newFinalValue >= 77 && newFinalValue <= 79){
       //      return "C+";
       //  }else if(newFinalValue >= 80 && newFinalValue <= 83){
       //      return "B-";
       //  }else if(newFinalValue >= 84 && newFinalValue <= 86){
       //      return "B";
       //  }else if(newFinalValue >= 87 && newFinalValue <= 89){
       //      return "B+";
       //  }else if(newFinalValue >= 90 && newFinalValue <= 93){
       //      return "A-";
       //  }else if(newFinalValue >= 94 && newFinalValue <= 96){
       //      return "A";
       //  }else if(newFinalValue >= 97 && newFinalValue <= 100){
       //      return "A+";
       //  }
    }
